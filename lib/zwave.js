...
var Zwave = function(server, options) {
  var options = options || {}
...
function setupZwave(options) {
  zwave = new OZW(options.USB_ADDRESS, options.config)
  ZwaveModel.setZwave(zwave)
...
Zwave.prototype.start = function() {
  console.log('Zwave: starting...')
  zwave.connect()
  console.log('Zwave: started')
}

Zwave.prototype.stop = function() {
  console.log('Zwave: stopping...')
  zwave.disconnect()
